...
def format_footer_text(run_url: str, elapsed_seconds: float | None = None) -> str:
    ...
    Returns:
        Formatted mrkdwn string like "Generated by <url|ClaudeChain> (41.8s)"
    """
    if elapsed_seconds is not None:
        return f"Generated by <{run_url}|ClaudeChain> ({elapsed_seconds:.1f}s)"
    return f"Generated by <{run_url}|ClaudeChain>"
