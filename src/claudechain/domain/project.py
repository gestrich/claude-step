...
class Project:
    ...
    def __init__(self, name: str, base_path: Optional[str] = None):
        ...
        Args:
            name: Project name
            base_path: Optional custom base path. Defaults to claude-chain/{name}
        """
        self.name = name
    ...
    def from_config_path(cls, config_path: str) -> 'Project':
        ...
        Args:
            config_path: Path like 'claude-chain/my-project/configuration.yml'
    ...
    def from_branch_name(cls, branch_name: str) -> Optional['Project']:
        ...
        Args:
            branch_name: Branch name like 'claude-chain-{project}-{hash}'
    ...
    def find_all(cls, base_dir: str = "claude-chain") -> List['Project']:
        ...
        Args:
            base_dir: Directory to scan for projects. Defaults to 'claude-chain'
