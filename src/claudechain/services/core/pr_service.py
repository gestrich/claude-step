...
class PRService:
    ...
    def get_project_prs(
        self, project_name: str, state: str = "all", label: str = "claudechain"
    ...
    def get_open_prs_for_project(
        self, project: str, label: str = "claudechain"
    ) -> List[GitHubPullRequest]:
    ...
    def get_merged_prs_for_project(
        self, project: str, label: str = "claudechain", days_back: int = DEFAULT_STATS_DAYS_BACK
    ) -> List[GitHubPullRequest]:
    ...
    def get_all_prs(
        self, label: str = "claudechain", state: str = "all", limit: int = 500
    ) -> List[GitHubPullRequest]:
    ...
    def format_branch_name(project_name: str, task_hash: str) -> str:
        ...
        Examples:
            ...
            'claude-chain-my-refactor-a3f2b891'
            >>> PRService.format_branch_name("swift-migration", "f7c4d3e2")
            'claude-chain-swift-migration-f7c4d3e2'
        """
    ...
    def format_branch_name_with_hash(project_name: str, task_hash: str) -> str:
        ...
        Examples:
            ...
            'claude-chain-auth-refactor-f7c4d3e2'
        """
        return f"claude-chain-{project_name}-{task_hash}"
    ...
    def parse_branch_name(branch: str) -> Optional[BranchInfo]:
        ...
        Examples:
            >>> info = PRService.parse_branch_name("claude-chain-my-refactor-a3f2b891")
            >>> info.project_name
            'my-refactor'
            >>> info.task_hash
            'a3f2b891'
