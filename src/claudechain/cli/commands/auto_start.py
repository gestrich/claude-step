...
from claudechain.domain.auto_start import AutoStartProject
...
def cmd_auto_start(
    ...
    try:
        ...
        if projects_to_trigger:
            ...
            triggered_projects, failed_projects = workflow_service.batch_trigger_claudechain_workflows(
...
def cmd_auto_start_summary(
    ...
    try:
        ...
        gh.write_step_summary("# ClaudeChain Auto-Start Summary")
