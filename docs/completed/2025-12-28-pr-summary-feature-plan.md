...
> **Note**: The prompt template was later moved from `scripts/claudechain/prompts/summary_prompt.md` to `src/claudechain/resources/prompts/summary_prompt.md` as part of a package restructuring effort. See `docs/proposed/move-prompt-template-to-resources.md` for details.

## Overview

Add an optional feature to post AI-generated summary comments on PRs created by ClaudeChain. The summary will analyze the PR diff and workflow context, explaining what was done and why in <200 words.
...
- [x] **Create Prompt Template** (`scripts/claudechain/prompts/summary_prompt.md`)
...
- [x] **Create Helper Script** (`scripts/claudechain/commands/prepare_summary.py`)
...
- [x] **Register Command in Dispatcher** (`scripts/claudechain/__main__.py`)

  Wire up the new command:

  - Import: `from claudechain.commands.prepare_summary import cmd_prepare_summary`
...
| `scripts/claudechain/prompts/summary_prompt.md` | Create | Prompt template for summary generation |
| `scripts/claudechain/commands/prepare_summary.py` | Create | Generate summary prompt with context |
| `scripts/claudechain/__main__.py` | Edit | Register prepare-summary command |
...
**Files Created:**
- `scripts/claudechain/prompts/summary_prompt.md` - Prompt template for Claude Code to generate PR summaries
- `scripts/claudechain/commands/prepare_summary.py` - Command handler for preparing summary prompts

**Files Modified:**
- `scripts/claudechain/__main__.py` - Registered `prepare-summary` command in CLI dispatcher
...
2. **Workflow Step 1 - Prepare summary prompt** (lines 146-162):
   ...
   - Executes: `python3 -m claudechain prepare-summary`
...
4. **CLI Testing Approach**:
   - Tested command directly via `python3 -m claudechain prepare-summary`
...
1. **Build Verification** ✅
   ...
   - No syntax errors or import issues
   - Files verified:
     - `scripts/claudechain/commands/prepare_summary.py`
     - `scripts/claudechain/__main__.py`
...
1. **Created:**
   - `scripts/claudechain/prompts/summary_prompt.md` - Prompt template
   - `scripts/claudechain/commands/prepare_summary.py` - Command handler
   - `tests/test_prepare_summary.py` - Unit tests (ready for pytest)

2. **Modified:**
   - `scripts/claudechain/__main__.py` - Added command registration
...
- ✅ `scripts/claudechain/prompts/summary_prompt.md` exists
- ✅ `scripts/claudechain/commands/prepare_summary.py` exists
...
**1. File Verification:**
- ✅ `scripts/claudechain/prompts/summary_prompt.md` exists (908 bytes)
- ✅ `scripts/claudechain/commands/prepare_summary.py` exists (2,531 bytes)
...
1. **File Verification:**
   - ✅ `scripts/claudechain/prompts/summary_prompt.md` (908 bytes)
   - ✅ `scripts/claudechain/commands/prepare_summary.py` (2,531 bytes)
...
1. Creates 3 PRs via the ClaudeChain workflow
...
1. **PR #23** - ClaudeChain: Create test-file-1.txt with content "Test 1"
   - Status: MERGED
   - Summary: ✓ Found AI-generated summary
   - Workflow: https://github.com/gestrich/claude-chain-demo/actions/runs/20526764108

2. **PR #24** - ClaudeChain: Create test-file-2.txt with content "Test 2"
   - Status: OPEN (then closed by test cleanup)
   - Summary: ✓ Found AI-generated summary
   - Workflow: https://github.com/gestrich/claude-chain-demo/actions/runs/20526795759

3. **PR #25** - ClaudeChain: Create test-file-3.txt with content "Test 3"
   - Status: OPEN (then closed by test cleanup)
   - Summary: ✓ Found AI-generated summary
   - Workflow: https://github.com/gestrich/claude-chain-demo/actions/runs/20526819912
...
---
*Generated by ClaudeChain • [View workflow run](https://github.com/gestrich/claude-chain-demo/actions/runs/20526795759)*
```
...
**1. File Existence Verification:**
- ✅ `scripts/claudechain/prompts/summary_prompt.md` (2.5K)
- ✅ `scripts/claudechain/commands/prepare_summary.py` (2.5K)
